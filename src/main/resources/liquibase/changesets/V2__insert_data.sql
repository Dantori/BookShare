INSERT INTO s_bookshare.t_users (name, login, city, role, password)
VALUES ('Илья', 'ilya@mail.ru', 'Рязань', 'ROLE_ADMIN', '$2a$10$rdrnJWU12IspjSJcJCzik.J.BU3P0A7vP0aHwor9FLeLXBVkDd6ze'),
       ('Филип', 'philip@mail.ru', 'Москва', 'ROLR_USER', '$2a$10$PluaJy8j.NBpzFYCO0MzhuR18Hk6crGdAVVrz01w6wstYtwiBGs9.');
